...
public class BrokerControler {
    ...
    public ResponseEntity<String> importCatalog(final HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file)
            throws Exception
    {
    ...
    public ResponseEntity<String> catalog( final HttpServletRequest httpServletRequest)
           throws Exception //JSONException, URISyntaxException
    {
        LOGGER.info("Request received: GET /v2/catalog request headers: " + headersString(httpServletRequest));
    ...
    public ResponseEntity<String> provision(final HttpServletRequest httpServletRequest,
                              @PathVariable("instanceId") final String instanceId,
                              @RequestParam(required = false, name="accepts_incomplete") final boolean acceptsIncomplete,
                              @RequestBody final JsonNode json)
           throws Exception
    {
        LOGGER.info("Create Service Instance request received: PUT /v2/service_instances/" + instanceId + "  ?accepts_incomplete=" + acceptsIncomplete
                + "  request body: " + json);
        // LOGGER.debug(" request headers: " + headersString(httpServletRequest));

        ResponseEntity<String> response = brokerService.provision(instanceId, json, BrokerUtil.getIamId(httpServletRequest),
                BrokerUtil.getHeaderValue(httpServletRequest, BrokerUtil.BLUEMIX_REGION_HEADER));
        LOGGER.info("Create Service Instance Response status: {}, body: {}", response.getStatusCode(), response.getBody());
        return response;
    ...
    public ResponseEntity<String> updateState(final HttpServletRequest httpServletRequest,
            @PathVariable("instanceId") final String instanceId,
            @RequestBody final JsonNode json)
           throws IOException
    {
        LOGGER.info("Update instance state request received: PUT /bluemix_v1/service_instances/" + instanceId + "request body: " + json);

        ResponseEntity<String> response = brokerService.updateState(instanceId, json, BrokerUtil.getIamId(httpServletRequest));

        LOGGER.info("Update instance state response status: {}, body: {}", response.getStatusCode(), response.getBody());
        return response;
    }
    ...
    public ResponseEntity<String> state(final HttpServletRequest httpServletRequest,
                          @PathVariable("instanceId") final String             instanceId)
           throws IOException
    {
        LOGGER.info("Get instance state request received: GET /bluemix_v1/service_instances/" + instanceId);
        // LOGGER.debug(" request headers: " + headersString(httpServletRequest));
        //validateAuthorization(httpServletRequest);

        // TODO - Do your actual work here
        ResponseEntity<String> response = brokerService.getState(instanceId, BrokerUtil.getIamId(httpServletRequest));
        LOGGER.info("Get instance state response status: {}, body: {}", response.getStatusCode(), response.getBody());
        return response;
    ...
    public ResponseEntity<String> bind(final HttpServletRequest httpServletRequest,
                         @PathVariable("instanceId") final String             instanceId,
    ...
    public ResponseEntity<String> unbind(final HttpServletRequest httpServletRequest,
                           @PathVariable("instanceId")  final String             instanceId,
                           @PathVariable("bindingId")   final String             bindingId,
           ...
           throws Exception
    {
        LOGGER.info("DELETE /v2/service_instances/" + instanceId + "/service_bindings/" + bindingId + "?plan_id=" + planId + "&service_id=" + serviceId);
    ...
    public ResponseEntity<String> deprovision(final HttpServletRequest httpServletRequest,
                                @PathVariable("instanceId")          final String             instanceId,
           ...
           throws Exception
    {
        LOGGER.info("Deprovision Service Instance request received: DELETE /v2/service_instances/" + instanceId + "  ?accepts_incomplete=" + acceptsIncomplete
                + " &plan_id=" + planId + " &service_id=" + serviceId);
        ResponseEntity<String> response = brokerService.deprovision(instanceId, planId, serviceId, BrokerUtil.getIamId(httpServletRequest));
        LOGGER.info("Deprovision Service Instance Response status: {}, body: {}", response.getStatusCode(), response.getBody());
        return response;
    }

    @PatchMapping("v2/service_instances/{instanceId}")
    public ResponseEntity<String> update(final HttpServletRequest httpServletRequest,
                           @PathVariable("instanceId") final String instanceId,
                           @RequestParam("accepts_incomplete") final boolean acceptsIncomplete,
                           @RequestBody final JsonNode json)
           throws Exception
    {
        LOGGER.info("Update Service Instance request received: PATCH /v2/service_instances/" + instanceId
                + " ?accepts_incomplete=" + acceptsIncomplete + " request body: " + json);
    ...
    public ResponseEntity<String> fetch(final HttpServletRequest httpServletRequest,
                          @PathVariable("instanceId")  final String             instanceId,
           ...
           throws Exception
    {
        LOGGER.info("Get last_operation request received: GET /v2/service_instances/" + instanceId + "?operation=" + operation
                + "&plan_id=" + planId + "&service_id=" + serviceId );
        
        ResponseEntity<String> response = brokerService.lastOperation(instanceId, BrokerUtil.getIamId(httpServletRequest));

        LOGGER.info("last_operation Response status: {}, body: {}", response.getStatusCode(), response.getBody());
        return response;
