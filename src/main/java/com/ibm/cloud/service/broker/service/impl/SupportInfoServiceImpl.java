...
public class SupportInfoServiceImpl implements SupportInfoService {
  ...
  private static final String IS_METERING_API_KEY_SET =
    "IS_METERING_APIKEY_SET";
  ...
  /**
   * return data required by ui to display on dashboard
   * @throws Exception
   */
  @Override
  public String getMetadata() throws Exception {
    ...
    metadata.put(
      IS_METERING_API_KEY_SET,
      (!"".equals(metringApikey)) ? true : false
    );
    return new ObjectMapper().writeValueAsString(metadata);
  }

  /**
   * map instance details to use in getServiceInstances
   * @throws Exception
   */
