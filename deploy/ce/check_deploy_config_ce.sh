...
if [ -z $ICR_IMAGE ] || [ $ICR_IMAGE == $EMPTY ] || [ -z $CE_REGISTRY_SECRET_NAME ] || [ $CE_REGISTRY_SECRET_NAME == $EMPTY ] || [ -z $BROKER_USERNAME ] || [ $BROKER_USERNAME == $EMPTY ] || [ -z $BROKER_PASSWORD ] || [ $BROKER_PASSWORD == $EMPTY ] || [ -z $BROKER_ICR_NAMESPACE_URL ] || [ $BROKER_ICR_NAMESPACE_URL == $EMPTY ] || [ -z $DEPLOYMENT_IAM_API_KEY ] || [ $DEPLOYMENT_IAM_API_KEY == $EMPTY ] || [ -z $CE_REGION ] || [ $CE_REGION == $EMPTY ] || [ -z $APP_NAME ]|| [ $APP_NAME == $EMPTY ] || [ -z $CE_RESOURCE_GROUP ] || [ $CE_RESOURCE_GROUP == $EMPTY ] || [ -z $CE_PROJECT ] || [ $CE_PROJECT == $EMPTY ];
then 
	echo ""
	echo "*******************************************************************************"
